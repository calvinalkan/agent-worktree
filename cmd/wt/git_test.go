...
func Test_gitRepoRoot_Returns_Root_When_In_Subdir(t *testing.T) {
	...
	root, err := git.RepoRoot(context.Background(), subdir)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func Test_gitRepoRoot_Returns_Error_When_Not_In_Repo(t *testing.T) {
	...
	_, err := git.RepoRoot(context.Background(), dir)
	if err == nil {
...
func Test_gitIsDirty_Returns_False_When_Clean(t *testing.T) {
	...
	dirty, err := git.IsDirty(context.Background(), dir)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func Test_gitWorktreeAdd_Creates_Worktree(t *testing.T) {
	...
	err := git.WorktreeAdd(context.Background(), repoPath, wtPath, "feature-branch", "master")
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func Test_gitWorktreeAdd_Returns_Error_When_Branch_Exists(t *testing.T) {
	...
	err = git.WorktreeAdd(context.Background(), repoPath, wtPath2, "feature-branch", "master")
	if err == nil {
...
func Test_gitWorktreeAdd_Creates_Worktree_From_Different_Branch(t *testing.T) {
	...
	err = git.WorktreeAdd(context.Background(), repoPath, wtPath, "feature-from-develop", "develop")
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func Test_gitWorktreeRemove_Removes_Worktree(t *testing.T) {
	...
	// Remove worktree
	err = git.WorktreeRemove(context.Background(), repoPath, wtPath, false)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func Test_gitWorktreeRemove_Removes_Dirty_Worktree_With_Force(t *testing.T) {
	...
	err = git.WorktreeRemove(context.Background(), repoPath, wtPath, true)
	if err != nil {
...
func Test_gitWorktreePrune_Succeeds(t *testing.T) {
	...
	err := git.WorktreePrune(context.Background(), repoPath)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
}
...
func Test_gitBranchDelete_Deletes_Branch(t *testing.T) {
	...
	// Delete the branch
	err = git.BranchDelete(context.Background(), repoPath, "feature-to-delete", false)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
...
func Test_gitBranchDelete_Returns_Error_When_Branch_Not_Merged(t *testing.T) {
	...
	err = git.BranchDelete(context.Background(), repoPath, "unmerged-branch", false)
	if err == nil {
...
func Test_gitBranchDelete_Force_Deletes_Unmerged_Branch(t *testing.T) {
	...
	err = git.BranchDelete(context.Background(), repoPath, "unmerged-branch", true)
	if err != nil {
		t.Fatalf("expected no error with force, got: %v", err)
	}
}
...
func Test_gitWorktreeList_Returns_Worktree_Paths(t *testing.T) {
	...
	paths, err := git.WorktreeList(context.Background(), repoPath)
	if err != nil {
		t.Fatalf("expected no error, got: %v", err)
	}
	...
	err = git.WorktreeAdd(context.Background(), repoPath, wtPath, "branch-1", "master")
	if err != nil {
		t.Fatalf("worktree add failed: %v", err)
	}
...
func Test_gitWorktreeList_Includes_Worktree_Path(t *testing.T) {
	...
	err := git.WorktreeAdd(context.Background(), repoPath, wtPath, "my-branch", "master")
	if err != nil {
		t.Fatalf("worktree add failed: %v", err)
	}
